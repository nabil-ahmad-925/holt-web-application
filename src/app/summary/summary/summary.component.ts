...
export class SummaryComponent {
  ...
  constructor(private apiService: ApiService, private modalService: DialogService, private toastr: ToastrService, private router: Router) { }
  ...
  redirectToSummaryPublicView(videoId: string) {
    this.router.navigate(['/public-view', videoId]);
  }
